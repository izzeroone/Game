...
bool TestSceneBackground::init()
{
	...
	_sprite3_first = makeSprite("part_07", 0, _sprite2_first->getPositionY() - _sprite2_first->getFrameHeight() + 1);
	_sprite4_first = makeSprite("part_06", 0, _sprite3_first->getPositionY() - _sprite3_first->getFrameHeight() + 1);
	_sprite5_first = makeSprite("part_05", 0, _sprite4_first->getPositionY() - _sprite4_first->getFrameHeight() + 1);
	_sprite6_first = makeSprite("part_04", 0, _sprite5_first->getPositionY() - _sprite5_first->getFrameHeight() + 1);
	_sprite7_first = makeSprite("part_03", 0, _sprite6_first->getPositionY() - _sprite6_first->getFrameHeight() + 1);
	_sprite8_first = makeSprite("part_02", 0, _sprite7_first->getPositionY() - _sprite7_first->getFrameHeight() + 1);
	_sprite9_first = makeSprite("part_01", 0, _sprite8_first->getPositionY() - _sprite8_first->getFrameHeight() + 1);
	...
	_sprite3_second = makeSprite("part_07", 0, _sprite2_second->getPositionY() - _sprite2_second->getFrameHeight() + 1);
	_sprite4_second = makeSprite("part_06", 0, _sprite3_second->getPositionY() - _sprite3_second->getFrameHeight() + 1);
	_sprite5_second = makeSprite("part_05", 0, _sprite4_second->getPositionY() - _sprite4_second->getFrameHeight() + 1);
	_sprite6_second = makeSprite("part_04", 0, _sprite5_second->getPositionY() - _sprite5_second->getFrameHeight() + 1);
	_sprite7_second = makeSprite("part_03", 0, _sprite6_second->getPositionY() - _sprite6_second->getFrameHeight() + 1);
	_sprite8_second = makeSprite("part_02", 0, _sprite7_second->getPositionY() - _sprite7_second->getFrameHeight() + 1);
	_sprite9_second = makeSprite("part_01", 0, _sprite8_second->getPositionY() - _sprite8_second->getFrameHeight() + 1);
