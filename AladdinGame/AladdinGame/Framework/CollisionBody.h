...
class CollisionBody : public IElement
{
public:
	CollisionBody(GameObject* target);
	...
	*/
	CollisionBody(GameObject* target, RECT bodyRect);
	...
	*/
	...
	sigcxx::Signal<pGameObject, eDirection> onCollisionBegin; // other object and direction
	sigcxx::Signal<pGameObject, eDirection> onCollisionEnd;
	/*
